...
import textscreen.data.fonts
from textscreen.views.screen import ScreenView

SCREEN_WIDTH = 1280
SCREEN_HEIGHT = 720
FPS_CAP = 240
SCREEN_TITLE = "TextScreen"

# Fix font lag
pyglet.options["advanced_font_features"] = True
arcade.pyglet.options["advanced_font_features"] = True

with pkg_resources.path(textscreen.data.fonts, "Fira Code Regular Nerd Font Complete Mono.ttf") as p:
